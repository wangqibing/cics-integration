    ...
    <script type="text/javascript">
        ...
        function logout() {
            if (confirm("您确定要退出本系统吗？")) {
                window.location.href = "/integration/login";
            }
        }
        ...
        function getDate01() {
            ...
            document.getElementById("day_day").innerHTML = currentdate;
            window.setInterval(getDate01, 1000 * 60);
        }
    ...
    <script type="text/javascript">
        ...
        function loadMenu(resourceType, treeObj) {
            /*$.ajax({
                type:"POST",
                url:"${dynamicURL}
            /authority/modelPart.action?resourceType=" + resourceType,
                            dataType : "json",
        ...
        <div id="top_op">
            <ul>
                <li>
                    ...
                    <span>${user.userCname}</span>
                </li>
                <li>
                    <img alt="日期" src="images/common/date.jpg">：
...
<div id="side">
    <div id="left_menu">
        <ul id="TabPage2" style="height:200px; margin-top:50px;">
            <li id="left_tab1" class="selected" onClick="javascript:switchTab('TabPage2','left_tab1');" title="业务模块">
                <img alt="集成管理模块" title="集成管理模块" src="images/common/1_hover.jpg" width="33" height="31">
            </li>
            <li id="left_tab2" onClick="javascript:switchTab('TabPage2','left_tab2');" title="系统管理">
                <img alt="用户管理模块" title="用户管理模块" src="images/common/2.jpg" width="33" height="31">
            </li>
    ...
    <div id="left_menu_cnt">
        <div id="nav_module">
            <img src="images/common/module_1.png" width="190" height="58"/>
        </div>
        <div id="nav_resource">
...
<div id="main">
    <iframe name="right" id="rightMain" src="question_list" frameborder="no" scrolling="auto" width="100%" height="100%"
