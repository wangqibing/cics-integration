...
public class ActivityDemoServiceImpl {
    ...
    private static ProcessEngine processEngines = ProcessEngines.getDefaultProcessEngine();
   @Value("${activiti.process}")
   private String process;
    ...
    public void startProcesses(String bizId) {
        ...
        ProcessInstance pi = runtimeService.startProcessInstanceByKey("myProcess_1", variables);//流程图id，业务表id
    ...
    public void depolyProcesses() {
                ...
                .addClasspathResource(process)//从classpath的资源中加载，一次只能加载一个文件
                .deploy();//完成部署
